						...
						<div class="" id="teacher-set-team">
			                ...
			                <div class="homework-content">
			                    ...
			                    <p class="question-son"style="margin-bottom: 0px;">
					                ...
					                <form action="" class="select" id="myForm">
				                        <div class="radio">
				                            <label>
				                                ...
				                                <span class="question-content">自由选择任务</span>
				                            </label>
				                        </div>
				                        <div class="radio">
				                            <label>
				                    ...
				                    <div class="line"></div>
				                    <span>我的任务：</span><span id="answerOrder"></span>
				                    <span class="task-score-wrap">分值：</span><span class="task-score">100</span>
			                    </p>
			                    
			                </div>
							<!--其他题-->
							<!--前一个页面  没有选择小组的时候，没有下面这两个按钮-->
							<div class="homework-group-leader-save">
								<a href="xiaozuzuoye-ziyoufenzu-zirenwu.html"><div class="btn yes group-leader-homework-save">做作业</div></a>		
    	...
    	<div class="modal-content leader-upload-content">
	        <div class="modal-header">
	       	...
	       	<div class="modal-body group-leader-upload-member">
	            <div class="row" style="width: 108%\0;">
...
<div class="submit-status">
    ...
    <span class="engage-success-text">已提交，等待老师批阅</span>
</div>
...
$(function(){
	...
	$(".submit-status").fadeIn().delay(800).fadeOut();
	})
})
</script>
</body>
