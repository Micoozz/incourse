  		...
  		<div class="container">
  			<div class="row">
  				...
  				<div class="col-xs-12 col-sm-12" id="centery" style="height: 100%">
	  				...
	  				<ul class="nav nav-tabs team-grade-select">
                        <li><a href="#look-up-grade" data-toggle="tab">查看成绩</a></li>
                    </ul>
	                ...
	                <div class="tab-content">
						...
						<div class="tab-pane" id="look-up-grade">3333333333333</div>-->
			                ...
			                <div class="homework-content">
			                   ...
			                   <!--此处和个人作业里面完全一样  后期若需修改 需要连同CSS页面一些class一起修改-->
			                	<p class="question-head">
			                        ...
			                        <!--问题-->
			                        选择题：下列规定中，哪一项不是1842年中英《南京条约》的内容？
			                    </p>
							...
							<div class="homework-group-leader-save">
								<div class="btn yes group-leader-homework-save" data-toggle="modal" data-target="#tips-of-save" >保存</div>		
								<div class="btn group-leader-homework-upload" data-toggle="modal" data-target="#group-leader-upload">组长提交</div>
							</div>
						</div>
						<!--分页内容一完毕-->
						<!--分页内容二开始-->
						<div class="tab-pane" id="free-set-team">
							
							
							<!--作业内容-->
			                <div class="homework-content">
			                	<a href="xiaozu-renwuxiangqing.html">
				                	<p class="task-head">
						...
						<!--分页内容二完毕-->
						<!--分页内容三开始-->
						<div class="tab-pane" id="look-up-grade">
    ...
    <div class="modal-dialog leader-upload-dialog">
    	<div class="modal-content leader-upload-content">
	        ...
	        <div class="modal-footer">
	            ...
	            <button type="button" class="btn center-block yes homework-submmit">
	               提交
	            </button>
	        </div>
      	</div>
