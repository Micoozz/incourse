                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="look-up-grade">
                            <div class="team-grade-wrap">
                                <span class="mate-grade-head">你的分数为</span>
                                <div class="mate-grade-bg">
                                    <img class="img-responsive center-block"
                                         src="images/homework/subject/homework-grade.png"/>
                                    <span class="mate-grade center-block">60</span>
                                </div>
                                <div class="team-grade-teacher-evaluate">
                                    <span class="teacher-evaluate-head">教师评价为</span>
                                    <p class="teacher-evaluate center-block"
                                       style="background-color:#59C5BB;color: #FFF;">小明这个娃啊，还不错</p>
                                </div>
                                <div class="team-grade-mate-evaluate">
                                    ...
                                    <div class="other-evaluate-jump-arrow">
                                        <a href="" class="other-evaluate-jump-left"><img
                                                    src="images/homework/homework-group/group-grade-left.png"/></a>
                                        <a href="" class="other-evaluate-jump-right"><img
                                                    src="images/homework/homework-group/group-grade-right.png"/></a>
                                    </div>
                                </div>
                                <button class="team-grade-foot btn center-block" data-toggle="modal"
                                        data-target="#uploadEvulate">评价小组
                                </button>
                            </div>
                        </div>
                        <!--分页内容三结束-->
    ...
    <div class="modal-dialog leader-upload-dialog">
        <div class="modal-content leader-upload-content">
            <div class="modal-header">
                ...
                <h4 style="font-size: 16px;" class="modal-title text-center" id="myModalLabel">提交作业</h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn center-block yes" data-toggle="modal" data-target="#leader-submit-success">提交</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="uploadEvulate" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog  currency-modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title text-center" id="myModalLabel">评价组员</h4>
            </div>
            <div class="modal-body">
                <textarea name="" rows="" cols="" class="evulate-input"></textarea>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn evulate-parterner center-block">发表</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog upload-fault-modal">
        <div class="modal-content upload-fault">
            ...
            <div class="modal-footer upload-fault-footer">
                <button type="button" class="btn yes upload-fault-save center-block">保存</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="group-member" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog group-member-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 style="font-size: 16px;" class="modal-title text-center" id="myModalLabel">查看小组成员</h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn center-block yes">确定</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade leader-save-modal" id="leader-no-authority" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content tips-of-save">
...
<div class="modal fade leader-save-modal" id="wait-others-to-submit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content tips-of-save">
