			...
			<div class="SectionListTitle">
				<div class="sectionTitle-parent">
					<div class="SectionList-title sectionTitle">
						...
						<div class="title-content"><span>第一章第一节</span></div>
						<span class="title-bar">
							<span><b>70%<i></i></b></span>
						</span>
					</div>
					<div class="SectionList-subTitle sectionTitle">
						<span class="titleTime"><i class="fa fa-clock-o"></i>第一章第一节</span>
						<span class="wrongClick ic-blue"><i class="fa fa-pencil"></i>错题练习</span>
					</div>
					<ul class="chapterList">
						...
						<li>
							...
							<div class="chapterTitle"><span class="chapterTitleTime titleTime"><i class="fa fa-clock-o"></i>第一章第一节</span><span class="wrongClick ic-blue"><i class="fa fa-pencil"></i>错题练习</span></div>
							<span class="dowmLine"></span>
						</li>
						<li>
		...
		<li class="wrongNoteBookSectionList">
			<div class="SectionListTitle">
				<div class="sectionTitle-parent">
					...
					<div class="SectionList-subTitle sectionTitle"><span class="titleTime"><i class="fa fa-clock-o"></i>第一章第一节</span><span class="wrongClick"></span></div>
					<ul class="chapterList">
