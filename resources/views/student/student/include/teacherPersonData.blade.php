    ...
    <div class="navbar">
        <div>
            ...
            <ul class="nav head_nav">
                <li class="schoolMain">
                    <a href="../Media/media.html">学校首页</a>
                    <div>
                        <a href="../Media/relateToMe.html">@与我相关</a>
                    </div>
                </li>
                <li><a href="Arrangement_work(homepage).html">学习中心</a></li>
                ...
                <li><a href="../Login/index.html" class="blue">退出</a></li>
            </ul>
        </div>
     </div>
<div class="content">
