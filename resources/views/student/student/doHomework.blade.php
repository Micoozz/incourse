...
<head lang="en">
    ...
    <link rel="stylesheet" href="../../css/student/doHomework.css"/>
</head>
<body>
        ...
        <div class="f-l do-hw">
            <div class="of-h p-r view">
                <ul class="ic-inline p-a exercise-box">
                    ...
                    <!--连线题-->
                    <li data-id="7" class="exer-in-list lian-xian-1">
                        <div class="clear hw-question">
                            <i class="student_icons query"></i>
                            <span class="ic-blue">（2016 华东师大）（
                    ...
                    <li data-id="8" class="exer-in-list">
                        <div class="clear hw-question">
                            ...
                            <span class="ic-blue">（2016 华东师大）（
                                ...
                                ）</span>
                        <span>结合下面句子中加点的文字，品析作者时怎么样表现“邂逅”的美丽的。
一个个或月光流泻、或雨打芭蕉的夜晚，我倚在床上，追随者林清玄先生的步伐，锦绣山河、风土人情、异国风光、人情冷暖、小人物的生存和命运......这一切充实、温暖和美丽着我的心灵。</span>
                        </div>
                        <hr/>
                        <div class="answer-box">
                    ...
                    <li data-id="9" class="exer-in-list ting-li dan-xuan-only">
                        ...
                        <div class="answer-box">
                            ...
                            <div class="one-hw">
                                <div class="clear hw-question">
                                    <span>1.下列各句中，标点符号使用正确的一项是（）</span>
                                </div>
                                <div>
                                    <ul class="radio-wrap exer-list-ul dan-xuan-options">
                                        <li>
                            ...
                            <div class="one-hw">
                                <div class="clear hw-question">
                        <span>2.fgfgfgfggflgflgflhg<span class="blank-item" contenteditable="true">空1</span>hgkhghgkhlgkhlghkglhkg<span
                                class="blank-item" contenteditable="true">空2</span>hlgkhglhkghglg khglhkghgthg hghrtedwdssdsgd
                            ht jhyj hjhkjk jkjklh.
                        </span>
                                </div>
...
<script src="../../js/jquery-ui-sortable.min.js" charset="utf-8"></script>
<script src="../../js/incourseReset.js" charset="utf-8"></script>
<script src="../../js/exercise.js" charset="utf-8"></script>
<script src="../../js/student/doHomework.js" charset="utf-8"></script>
</body>
</html>