...
<body>
    ...
    <div class="content">
                    ...
                    <div class="col-xs-12 col-sm-12  data-storage" id="centery">
                        ...
                        <div class="container-fluid" id="grade-container">
                            ...
                            <!--
                                ...
                                <div class="row count2">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
                                    <div class="ta-r col-lg-4 col-md-4 col-sm-4 col-xs-4">填空题（共20分）</div>
                                    <div class="ta-c col-lg-3 col-md-3 col-sm-3 col-xs-3">得分：<span
                                ...
                                <div class="row count2">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
                                    <div class="ta-r col-lg-4 col-md-4 col-sm-4 col-xs-4">排序题（共20分）</div>
                                    <div class="ta-c col-lg-3 col-md-3 col-sm-3 col-xs-3">得分：<span
                                ...
                                <div class="row count2">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
                                    <div class="ta-r col-lg-4 col-md-4 col-sm-4 col-xs-4">多选题（共30分）</div>
                                    <div class="ta-c col-lg-3 col-md-3 col-sm-3 col-xs-3">得分：<span
                            ...
                            <div class="row count3">
                                ...
                                <!--
                                    <div class="row count2">
                                        ...
                                        <div class="ta-c col-lg-3 col-md-3 col-sm-3 col-xs-3 red">得分：<span
                                    ...
                                    <div class="row count2">
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
                                        <div class="ta-r col-lg-4 col-md-4 col-sm-4 col-xs-4">画图题（共10分）</div>
                                        <div class="ta-c col-lg-3 col-md-3 col-sm-3 col-xs-3 red">得分：<span
                            ...
                            <ul class="nav">
                                <li class="row">
                                    <div class="chatRoom1 col-md-12">
                                        ...
                                        <span class="ta-r c-p f-r col-md-1">X</span>
                                    </div>
        ...
        <script src="js/sJS/danrenzuoye-chengji.js"></script>
    </body>
    </html>