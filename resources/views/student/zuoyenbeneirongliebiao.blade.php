                ...
                <div class="col-xs-12 col-sm-12" id="centery">
                    ...
                    <div class="homework-list-box">
                        ...
                        <div class="homework-list row">
                            <a href='/showWorkDetail/{{ $work->id }}' class="homework-type-link not-open pointer">
                                <img src="images/homework/engage/single.png" class="homework-type-select-img"/>
                                <span class="homework-order">{{ $work->belongsToJob->title }}</span>
                            </a>
                            <table class="homework-list-content col-lg-8 col-md-8 col-xs-8" cellpadding="0"
                                ...
                                <tr>
                                    <td>
	                                    ...
	                                    {{ date('m月d日 h:i',$work->belongsToJob->pub_time) }}
	                                    </span>
                                        </div>
                                    </td>
                                    <td>
	                                    ...
	                                    {{ date('y-m-d h:i:s',$work->belongsToJob->deadline) }}
	                                    </span>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
	                                    ...
	                                    <span class="circle-value5">
	                                     @if($work->status == 1) 发布 @elseif($work->status == 3) 未提交 @else 关闭 @endif
	                                    </span>
                                        </div>
                                    </td>
                                </tr>
