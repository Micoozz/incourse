                ...
                <div class="col-xs-12 col-sm-12" id="centery">
                    ...
                    <div class="homework-content">
                        ...
                        <div class="question-foot">
                            ...
                            <a href="ziliaoku-xiangxineirong.html" class="search-wiki"><img
                                        src="images/homework/subject/link.png" alt=""/>
                                查看资料</a>
                            <span class="question-fault" data-toggle="modal" data-target="#uploadFault">报错</span>
                        </div>
                    </div>
                    <div class="homework-content">
                        ...
                        <span class="order">
                            ...
                            <!--问题-->
                            多空题：I made my coat <span class="question-blank">空1</span> my own hands.It was madehand
                            not<span class="question-blank">空2</span>with a machine.
                        </p>
                        <form action="" class="select" id="myForm">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="questionMultiBlankSelect" class="questionMultiBlankSelect"
...
<div class="answerInput" id="answerInput">
    ...
    <h4 class="text-center" id="myModalLabel">请输入你的答案</h4>
    <div>
    ...
    <div class="modal-dialog answer-input-modal">
        <div class="modal-content upload-fault" style="font-size: 14px">
            ...
            <div class="modal-footer upload-fault-footer">
                <button type="button" class="btn upload-fault-save center-block">保存</button>
            </div>
        </div>
    </div>
</div>
