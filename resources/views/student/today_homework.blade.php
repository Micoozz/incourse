                        ...
                        <form action="" class="select" id="myForm">
                            <div class="radio">
                                <label>
                                    ...
                                    <span class="select-wrapper"></span>A.
                                    <span class="question-content"><span class="dot">着</span>陆
                                    <span class="dot">着</span>落
                                    <span class="dot">着</span>火
                                    <span class="dot">着</span>急</span>
                                </label>
                            </div>
                            <!--问题字符大小均为14px-->
                            <div class="radio">
                            ...
                            <div class="radio">
                                <label>
                                    ...
                                    <span class="question-content">羡<span class="dot">慕</span> <span
                                                class="dot">募</span>捐 <span class="dot">帷</span>幕 <span
                    ...
                    <div class="homework-content">
                        ...
                        <div class="question-foot">
                            ...
                            <a href="javascript:;" class="search-wiki"><img src="images/homework/subject/link.png" alt=""/>
                                <span class="search-wiki-span">查看资料</span>
                            </a>
                            <span class="question-fault" data-toggle="modal" data-target="#uploadFault">报错</span>
                        </div>
                    </div>
