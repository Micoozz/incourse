...
<body>
    ...
    <div class="navbar">
        <div>
            ...
            <ul class="nav head_nav">
                ...
                <li><a href="addEmployeeFile.html" class="blue">档案管理</a></li>
                <li class="affix">
  ...
  -->
                        ...
                        <div id="information_content">
                            <div id="basic_information">
                                ...
                                <form class="info" id="stu_info" action="">
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="row add_file_info1">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <input type="text" placeholder="户籍类型" style="width:94%">
                                                    </div>
                                                </div>
                                                <div class="row add_file_info1">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <input type="text" type="text" id="birthTime"  class="inline laydate-icon date-input-table" placeholder="出生年月" style="width:94%">
                                                    </div>
                                                </div>
                                                <div class="row add_file_info1">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <input type="text" placeholder="学生电话" style="width:94%">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row info2">
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                                            <input type="text" placeholder="所在年级" class="basic-bottom-left">
                                        </div>
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <input type="text" placeholder="现任班级" class="basic-bottom-right">
                                        </div>
                                    </div>
                                    <div class="row info2">
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                                            <input type="text" placeholder="现班主任" class="basic-bottom-left">
                                        </div>
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    ...
                                    <div class="row info2">
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                                            <input type="text" placeholder="身份证号" class="basic-bottom-left">
                                        </div>
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <input type="text" placeholder="学籍号码" class="basic-bottom-right">
                                        </div>
                                    </div>
                                    <div class="row info2">
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                                        ...
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <input type="text" placeholder="加入时间" id="joinTime"  class="inline laydate-icon basic-bottom-right">
                                        </div>
                                    </div>
                                    <div class="row info2">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <input type="text" placeholder="学籍状态" class="remark-line">
                                        </div>
                                    </div>
                                    <div class="row info2">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <textarea class="remark-textarea" placeholder="备注信息"></textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div id="student_evaluation">
                                <div class="add_file_top_image">
                                    <div class="img_left">R</div>
                                    <div class="img_right">
                                        <div class="img_right_up"><span>奖惩记录</span></div>
                                        <div class="img_right_down">eward information</div>
                                    </div>
                                </div>
                                ...
                                <form class="info" id="stu_eval" action="">
                                    <div class="row info2">
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                                            <span class="basic-bottom-left">
                                            	<span class="reward-type-span">记录类型</span>
                                            	<select class="reward-type-select">
                                        ...
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <input type="text" placeholder="发生时间" id="happenTime" class="inline laydate-icon basic-bottom-right">
                                        </div>
                                    </div>
                                    <div class="row info2">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <textarea class="remark-textarea" placeholder="具体内容"></textarea>
                                        </div>
                                    </div>
                                    <div class="add-more-line-reward">
                                        <span>+&nbsp继续添加</span>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div id="class_position">
                                <div class="add_file_top_image">
                                    <div class="img_left">E</div>
                                    <div class="img_right">
                                        <div class="img_right_up"><span>评价信息</span></div>
                                        <div class="img_right_down">valuative information</div>
                                    </div>
                                </div>
                                <div class="fileRestract "><a href="javascript:;" id="pos_retract">展开<span class="caret"></span></a></div>
                                <form class="info" id="stu_pos">
                                    <div class="row info2">
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
                                            <input type="text" placeholder="学期时间" class="basic-bottom-left">
                                        </div>
                                        <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <input type="text" placeholder="评价人" class="basic-bottom-right">
                                        </div>
                                    </div>
                                    <div class="row info2">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="add-more-line-evaluative">
                                        <span>+&nbsp继续添加</span>
                                    </div>
                                </form>
                            </div>
    ...
    $(function() {
        ...
        $('.add-more-line-reward').click(function() {
            $('.add-more-line-reward').before('<div class="row info2"><div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6 "><span class="basic-bottom-left"><span class="reward-type-span">记录类型</span><select class="reward-type-select"><option value="">奖励</option><option value="">惩罚</option></select></span></div><div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6"><input type="text" placeholder="发生时间" class="basic-bottom-right"></div></div><div class="row info2"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><textarea class="remark-textarea" placeholder="具体内容"></textarea></div></div>');
        });
        $('.add-more-line-evaluative').click(function() {
            $('.add-more-line-evaluative').before('<div class="row info2"><div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6 "><input type="text" placeholder="学期时间" class="basic-bottom-left"></div><div class=" col-lg-6 col-md-6 col-sm-6 col-xs-6"><input type="text" placeholder="评价人" class="basic-bottom-right"></div></div><div class="row info2"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><textarea class="remark-textarea" placeholder="具体内容"></textarea></div></div>');
        });
