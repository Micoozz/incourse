...
<html>
  ...
  -->
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-12" id="centery">
                            ...
                            <input type="text"/>
								...
								<label for="">
                            <span class="particular">具体内容：</span>
                            <textarea></textarea>
                        </label>
								<label for="">
                            <span>落款单位：</span>
                            <input type="text"/>
								...
								<div class="clear"></div>
								<span class="affi">生成预览</span>
								<input type="submit" value="立即保存" class="btn btn-primary"/>
								<!--点击‘立即保存’跳转到上一个页面中并生成新的内容-->
								<input type="button" value="继续添加" class="btn btn-primary"/>
								<div id="last_1">
									<h2>奖金</h2>
									<div class="true">
										<div contenteditable="true" class="boxr">小明同学</div>	
									<br>
											<div contenteditable="true" style="text-indent: 20px;line-height: 20px;">在学校举办的校运会中<br/>获得了第一名希望你能在今后的学习与生活中继续进步，更创佳绩。</div>
										<div class="biaot" contenteditable="true">广东 省 二 中 学 撒施省长春市省级教育中心 二〇〇八年十一月一日</div>
									</div>
									<input type="submit" name="" value="保存" class="btn btn-primary" />
								</div>
							</form>
							<div class="succeed">添加成功</div>
						</div>
						<!--右侧栏-->
    ...
    <script type="text/javascript" src="js/jquery-1.12.4.min.js" ></script>
		...
		<script src="js/Teaching5.js"></script>
