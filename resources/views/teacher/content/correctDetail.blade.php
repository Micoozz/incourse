				...
				<div>
					<div class="p-r admin-container">
						<div class="person-hw-mark-head clear">
							<a class="ic-blue c-d p-r blue-hover lookSameExer">查看学生同类型练习题</a>
							<div class="f-r">
								<span class="isMark doMark active">客观题</span>
								<span class="isMark notMark">主观题</span>
							</div>
						</div>
						<!--客观题-->
						<div class="person-correct-did">
							<ul class="ic-inline clear person-hw-derail">
								...
								<li class="ta-r">
									<span>请打分：</span>
									<input class="border score" type="text" value="60" disabled="true" />
								</li>
							</ul>
							<!--题目列表，都是客观题-->
							<div class="exer-list">
								...
								<div class="questions">
									...
									<div class="result issue">
										...
										<span>
											...
											<br />
											(1) （5分）
											<div class="amend" contenteditable="false">
												
											</div>
										</span>
										<!--<canvas class="mycanvas" id="mycanvas" title="请选中批注文字" width="551" height="150"></canvas>-->
									</div>
...
@section('JS:OPTIONAL')
<!-- <script src="/js/teacher/add_teacher_left_navbar.js" charset="utf-8"></script> -->
...
<script>
	$(function() {
		...
		$('body').on('click', '.isMark', function() {
			$('.isMark').removeClass('active')
