					...
					<div class="row">
						...
						<div class="col-xs-12" id="left">
							<ul class="nav1 nav" id="nav1">
								<li>
									<a href="Arrangement_work(homepage).html" class="box">作业管理</a>
								</li>
								<li>
									<a href="Exercise_editor.html">习题库</a>
								</li>
								<li>
										...
										<div class="end" id="div1">
											...
											<div class="row">
											   ...
											   <div class=" col-md-8 new_mlbtn">
												<a href="Favorites.html"  class="bt_a">取消</a>
												<a href="#" class="bt_s Ad-se">发布</a>
												<a href="Exercise_editor.html" class="bt_s">题库选题</a>
												<a href="Independent_operation_Add_topic.html" class="bt_s">添加题目</a>
