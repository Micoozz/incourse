     ...
     <div class="col-xs-12 col-sm-12" id="centery">
          <div class="files_nav">
               ...
               <span class="col-xs-3 col-sm-3 add"><a href=""><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;添加老师</a></span>
          </div>
     ...
     <div class="school-container admin-container">
          <div class="manageAdmin-wrap">
               <div class="search-box clear p-r">
                    <span class="admeasure on" num=1 onclick="window.location.href='/fileManager/teacher-file/authorized-teacher/{{ $parameter }}'">已分配</span>
                    <span class="admeasure " num=2 onclick="window.location.href='/fileManager/teacher-file/unauthorized-teacher/{{ $parameter }}'">未分配</span>                                 
          ...
          <table class="admin-list border admin-list-a">
               ...
               <tbody>
                    @foreach($data['allot'] as $employee)
                    <tr>
                         <td>{{ $employee->name }}</td>
                         ...
                         @else
                         <td class="ic-blue">
                              <a href="/fileManager/teacher-file/teacher-update/{{ $employee->id }}" num="0">
