...
<style type="text/css">
	...
	.mains div:first-child span:last-child{
		float:right;
	}
		...
		<div class="f-l do-hw">
			...
			<div class="mains">
				<div>
					...
					<span><b>30</b>人未提交</span>
				</div>
				<div id="main" style="width: 1000px;height:400px;"></div>
			</div>
			<div class="ta-c">
				<a href="/courseWare/answerEnd"><button class="ic-btn">查看统计</button></a><button class="ic-btn">终止计时</button>
			</div>
		</div>
	</div>
@endsection
