    ...
    $.fn.extend({
        uploaderAjax: function (options) {
            ...
            this.each(function(){
                ...
                wrapper.append("<h3 class='loaded-title'><i class='fs fs-pen'></i>点击修改"+options.name+"</h3>")
                ...
                var fileChanged = function(event){
                    ...
                    $.ajaxFileUpload({
                        ...
                        url: options.url + "&_file=" + uploadName, //用于文件上传的服务器端请求地址
