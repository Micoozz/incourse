...
class LearningCenterController extends Controller
{
    ...
    public function homotypology($exercises_id, $work_id, $accuracy, $increase){
    	...
    	$data = array();
    	$error_exercise_list = Exercises::select('categroy_id', 'id', 'score', 'chapter_id')->whereIn('id', $exercise_id)->orderByRaw(DB::raw("FIELD(id, ".implode(',', $exercise_id_arr).')'))->get();//查询出所有错题的数据
